from settings import REGISTER_COMMAND, RPSLS_START_COMMAND, RPSLS_GAME_START_TIMER, RPSLS_GAME_ROUND_TIMER


# Basic /start command message
RPSLS_START_COMMAND_MESSAGE = (
    f"""КАМЕНЬ-НОЖНИЦЫ-БУМАГА-ЯЩЕРИЦА-СПОК.\n
...
RPSLS_NO_CHOICE_MESSAGE = "Щас бы начать игру и не выбирать... А ещё меня ботом обзывают..."

YOU_ARE_ALREADY_IN_GAME_MESSAGE = "Падажжи, ты уже играешь."

RPSLS_GAME_STARTED_MESSAGE = f"{{user_1}} и {{user_2}} в зарубе. У вас {RPSLS_GAME_ROUND_TIMER} секунд."
